...
//     category: "frontend",
//     title: "project 1",
//     description: "lorem fneufeuuebecue neincwecw c wocwocw  cewhoi",
...
//             })}
//             {/* slider buttons */}
//             <WorkSliderBtns containerStyles="flex gap-2 absolute right-0 bottom-[calc(50%_-_22px)] xl:bottom-0 z-20 w-full justify-between xl:w-max xl:justify-none" btnStyles="bg-accent hover:bg-accent-hover rounded-full text-primary text-[22px] w-[44px] h-[44px] flex justify-center items-center transition-all"/>
//           </Swiper>
//         </div>
//       </div>
//     </div>
